    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${isLive
      ...
      <div className="grid grid-cols-12 gap-4 mt-4">
            ...
            <div className="h-[520px] overflow-y-auto space-y-2">
              {threats.length === 0 ? (
                <div className="text-center text-muted-foreground py-8">
                  <div className="w-12 h-12 bg-secondary dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg className="w-6 h-6 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <p>Waiting for threat data...</p>
                  {isLive && <p className="text-sm text-muted-foreground mt-1">Monitoring global threats</p>}
                </div>
              ) : (
                threats.map((threat) => (
                  <div
                    key={threat.id}
                    className="bg-slate-50 dark:bg-slate-800/80 rounded-lg p-3 border border-border hover:shadow-md hover:border-blue-500/30 transition-all"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <h4 className="text-foreground font-medium text-sm">{threat.type}</h4>
        ...
        <div className="col-span-12">
          <div className="bg-card border border-border rounded-xl p-6 transition-theme">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-foreground">AI Threat Insights</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-secondary dark:bg-gray-800 rounded-lg p-4">
                <div className="text-sm text-muted-foreground mb-1">Most Frequent Attack</div>
                <div className="text-lg font-semibold text-orange-400">{insights.mostFrequentAttack}</div>
              </div>

              <div className="bg-secondary dark:bg-gray-800 rounded-lg p-4">
                <div className="text-sm text-muted-foreground mb-1">Most Attacked Country</div>
              ...
              <div className="bg-secondary dark:bg-gray-800 rounded-lg p-4">
                <div className="text-sm text-muted-foreground mb-1">Critical Attacks</div>
